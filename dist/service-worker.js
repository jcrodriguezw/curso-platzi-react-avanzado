...
define("./service-worker.js",['./workbox-d0862690'], function (workbox) { 'use strict';
  ...
  */
  ...
  workbox.precacheAndRoute([{
    "url": "/index.html",
    "revision": "b99299233cbf2fcb85f67f1faad573af"
  }, {
    "url": "/src_pages_Favs_js.app.bundle.js",
    "revision": "aa8f6723950094f45b3f29bf97ae3f7e"
  }, {
  ...
  workbox.registerRoute(/https:\/\/petgram-server-one-amber.vercel.app\/graphql/, new workbox.NetworkFirst({
    "cacheName": "api",
    plugins: []
  }), 'GET');
